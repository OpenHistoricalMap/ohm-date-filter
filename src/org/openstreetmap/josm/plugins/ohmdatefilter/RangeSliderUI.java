...
//        Color semiTransparentGreen = new Color(0, 255, 0, 100);  // 128 is 50% opacity
        g2d.setColor(new Color(255, 193, 1, 220));
        g2d.fill(thumbShape);

        g2d.setColor(new Color(255, 193, 1, 250));
        g2d.draw(thumbShape);
...
//        Color semiTransparentRed =  // 128 is 50% opacity

        g2d.setColor(new Color(249, 108, 108, 220));
        g2d.fill(thumbShape);
        g2d.setColor(new Color(249, 108, 108, 250));
